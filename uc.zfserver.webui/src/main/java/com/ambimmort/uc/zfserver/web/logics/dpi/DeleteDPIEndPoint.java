 ...
 * @author 定巍
 */
@WebServlet(name = "DeleteDPIEndPoint", urlPatterns = {"/logic/dpi/DeleteDPIEndPoint"})
public class DeleteDPIEndPoint extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DPIEndPointBean bean = dao.queryBuilder().where().eq("devName", devName).queryForFirst();
            if(bean!=null){
                dao.delete(bean);
