 ...
 * @author 定巍
 */
@WebServlet(name = "GetDPIConfiguredPolicyRepos", urlPatterns = {"/logic/dpi/getDPIConfiguredPolicyRepos"})
public class GetDPIConfiguredPolicyRepos extends HttpServlet {
