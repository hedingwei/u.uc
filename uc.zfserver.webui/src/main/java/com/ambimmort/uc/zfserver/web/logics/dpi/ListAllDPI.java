 ...
 * @author 定巍
 */
@WebServlet(name = "ListAllDPI", urlPatterns = {"/logic/dpi/list"})
public class ListAllDPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                List<DPIEndPointBean> allDpis = dao.queryForAll();
                out.print(JSONArray.fromObject(allDpis));
