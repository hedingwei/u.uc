...
public class PolicySynTask extends TimerTask {
    ...
    public void run() {
        ...
        try {
            ...
            for (String devName : allDPIDevNames()) {
...
//            List<RepositoryOperationBean> actions = getUpdateOperation(type, instance, taskMap.get(type).start);
            ...
            Dao<ZFTask_PolicySynchronization, Long> dao = ZFDaoManager.getInstance().getDao(ZFTask_PolicySynchronization.class);
    ...
    private Map<String, Long> getCurrentVersion(String devName, HashMap<String, String>... configMaps) throws SQLException, Exception {
        ...
        HashMap<String, String> configMap = (HashMap<String, String>) JSONObject.toBean(JSONObject.fromObject(config), HashMap.class);
    ...
    private Map<String, Long> getReportedVersion(String devName) throws SQLException {
        Dao<UcData_DPIReportedPolicyVersionBean, Long> rdao = ZFDaoManager.getInstance().getDao(UcData_DPIReportedPolicyVersionBean.class);
        Map<String, Long> versions = new HashMap<String, Long>();
    ...
    private List<String> allDPIDevNames() throws SQLException {
        List<String> names = new ArrayList<String>();
        for (DPIEndPointBean bean : DPIEndPointBeanDao.getInstance().getDpiEndPointDao().queryForAll()) {
